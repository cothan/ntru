...
def _transpose_16x16_to_16x16(dst, src, src_off=0, dst_off=0, src_gap=3, dst_gap=1, dst_limit=None):
    ...
    p("vpunpcklwd ( y{}, vld1q_s16({}+{}) ) = y{}".format(s[0], 16*(src_gap*1+src_off), src,  t[0]))
    p("vpunpckhwd ( y{}, vld1q_s16({}+{}) ) = y{}".format(s[0], 16*(src_gap*1+src_off), src,  t[1]))
    p("vpunpcklwd ( y{}, vld1q_s16({}+{}) ) = y{}".format(s[2], 16*(src_gap*3+src_off), src,  t[2]))
    p("vpunpckhwd ( y{}, vld1q_s16({}+{}) ) = y{}".format(s[2], 16*(src_gap*3+src_off), src,  t[3]))
    p("vpunpcklwd ( y{}, vld1q_s16({}+{}) ) = y{}".format(s[4], 16*(src_gap*5+src_off), src,  t[4]))
    p("vpunpckhwd ( y{}, vld1q_s16({}+{}) ) = y{}".format(s[4], 16*(src_gap*5+src_off), src,  t[5]))
    p("vpunpcklwd ( y{}, vld1q_s16({}+{}) ) = y{}".format(s[6], 16*(src_gap*7+src_off), src,  t[6]))
    p("vpunpckhwd ( y{}, vld1q_s16({}+{}) ) = y{}".format(s[6], 16*(src_gap*7+src_off), src,  t[7]))

    r = list(range(0,4)) + list(range(12, 16))
    p("vpunpckldq (y{}, y{}) = y{}".format(t[0], t[2],  r[0]))
    p("vpunpckhdq (y{}, y{}) = y{}".format(t[0], t[2],  r[1]))
    p("vpunpckldq (y{}, y{}) = y{}".format(t[1], t[3],  r[2]))
    p("vpunpckhdq (y{}, y{}) = y{}".format(t[1], t[3],  r[3]))
    p("vpunpckldq (y{}, y{}) = y{}".format(t[4], t[6],  r[4]))
    p("vpunpckhdq (y{}, y{}) = y{}".format(t[4], t[6],  r[5]))
    p("vpunpckldq (y{}, y{}) = y{}".format(t[5], t[7],  r[6]))
    p("vpunpckhdq (y{}, y{}) = y{}".format(t[5], t[7],  r[7]))

    p("vpunpcklqdq (y{}, y{}) = y{}".format(r[0], r[4],  t[0]))
    p("vpunpckhqdq (y{}, y{}) = y{}".format(r[0], r[4],  t[1]))
    p("vpunpcklqdq (y{}, y{}) = y{}".format(r[1], r[5],  t[2]))
    p("vpunpckhqdq (y{}, y{}) = y{}".format(r[1], r[5],  t[3]))
    p("vpunpcklqdq (y{}, y{}) = y{}".format(r[2], r[6],  t[4]))
    p("vpunpckhqdq (y{}, y{}) = y{}".format(r[2], r[6],  t[5]))
    p("vpunpcklqdq (y{}, y{}) = y{}".format(r[3], r[7],  t[6]))
    p("vpunpckhqdq (y{}, y{}) = y{}".format(r[3], r[7],  t[7]))
    ...
    p("vpunpcklwd {}({}), y{}, y{}".format(16*(src_gap*9+src_off), src, s[0], t[8]))
    p("vpunpckhwd {}({}), y{}, y{}".format(16*(src_gap*9+src_off), src, s[0], t[9]))
    t[12] = s[0]
    p("vpunpcklwd {}({}), y{}, y{}".format(16*(src_gap*11+src_off), src, s[2], t[10]))
    p("vpunpckhwd {}({}), y{}, y{}".format(16*(src_gap*11+src_off), src, s[2], t[11]))
    t[13] = s[2]
    p("vpunpcklwd {}({}), y{}, y{}".format(16*(src_gap*13+src_off), src, s[4], t[12]))
    p("vpunpckhwd {}({}), y{}, y{}".format(16*(src_gap*13+src_off), src, s[4], t[13]))
    t[14] = s[4]
    p("vpunpcklwd {}({}), y{}, y{}".format(16*(src_gap*15+src_off), src, s[6], t[14]))
    t[15] = s[6]  # this is a super tight fit, but it still works out
    p("vpunpckhwd {}({}), y{}, y{}".format(16*(src_gap*15+src_off), src, s[6], t[15]))
    ...
    for i in range(7):  # t[7] is tricky
        ...
        p("vmovdqa y{}, {}({})".format(free, 16*(dst_gap*i+dst_off), dst))
    ...
    p("vmovdqa y{}, {}({})".format(t[14], 16*(dst_gap*7+dst_off), dst))
    ...
    if dst_limit is None or 15 < dst_limit:
        ...
        p("vmovdqa y{}, {}({})".format(t[15], 16*(dst_gap*15+dst_off), dst))
