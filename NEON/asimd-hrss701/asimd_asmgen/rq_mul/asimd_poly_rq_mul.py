...
def poly_Rq_mul(c, a, b):
    ...
    for coeff in range(3):
        ...
        for i in range(7):
            karatsuba_interpolate(dst='rsp', dst_off=i*4*2, src=r_out, src_off=i*9*6, coeff=coeff, t0, t1, t2)
