...
void sample_iid(poly *r,
                const unsigned char uniformbytes[NTRU_SAMPLE_IID_BYTES]) {
  ...
  vst1q_u16(85 + r->coeffs, y11);
  vst1q_u16(86 + r->coeffs, y11);
  vst1q_u16(87 + r->coeffs, y11);
  r->coeffs[677] = 0;
  r->coeffs[678] = 0;
  r->coeffs[679] = 0;
  r->coeffs[680] = 0;
