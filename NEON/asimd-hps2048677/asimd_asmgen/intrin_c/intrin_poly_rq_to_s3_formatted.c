...
void poly_Rq_to_S3(poly *r, const poly *a) {
  ...
  y8 = vdupq_n_u16(0x3);
  y16 = vdupq_n_s16(0x3);
  y10 = vdupq_n_u16(2047);
  y13 = vdupq_n_u16(0xff);
  y14 = vdupq_n_u16(0xf);
  // Find Last
  y9 = vld1q_u16(672 + a->coeffs);
  y9 = vandq_u16(y10, y9);
  y0 = vshrq_n_u16(y9, 10);
  y0 = veorq_u16(y8, y0);
  y0 = vshlq_n_u16(y0, 11);
  y0 = vaddq_u16(y0, y9);
  y9 = vdupq_laneq_u16(y0, 5);
  y9 = vshlq_n_u16(y9, 1);
  // Done Find Last
  // 0 -> 16
  ...
  y2 = vandq_u16(y10, y2);
  y3 = vandq_u16(y10, y3);
  y0 = vshrq_n_u16(y2, 10);
  y1 = vshrq_n_u16(y3, 10);
  y0 = veorq_u16(y8, y0);
  y1 = veorq_u16(y8, y1);
  y0 = vshlq_n_u16(y0, 11);
  y1 = vshlq_n_u16(y1, 11);
  y0 = vaddq_u16(y0, y2);
  y1 = vaddq_u16(y1, y3);
  y0 = vaddq_u16(y0, y9);
  y1 = vaddq_u16(y1, y9);
  ...
  vst1q_u16(85 + r->coeffs, y15);
  vst1q_u16(86 + r->coeffs, y15);
  vst1q_u16(87 + r->coeffs, y15);
  r->coeffs[677] = 0;
  r->coeffs[678] = 0;
  r->coeffs[679] = 0;
  r->coeffs[680] = 0;
