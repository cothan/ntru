...
void poly_mod_q_Phi_n(poly *r) {
  ...
  // 688 -> 704
  y0 = vld1q_u16(688 + r->coeffs);
  y1 = vld1q_u16(696 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  y1 = vsubq_u16(y1, y2);
  vst1q_u16(688 + r->coeffs, y0);
  vst1q_u16(696 + r->coeffs, y1);
  // 704 -> 720
  y0 = vld1q_u16(704 + r->coeffs);
  y1 = vld1q_u16(712 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  y1 = vsubq_u16(y1, y2);
  vst1q_u16(704 + r->coeffs, y0);
  vst1q_u16(712 + r->coeffs, y1);
  // 720 -> 736
  y0 = vld1q_u16(720 + r->coeffs);
  y1 = vld1q_u16(728 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  y1 = vsubq_u16(y1, y2);
  vst1q_u16(720 + r->coeffs, y0);
  vst1q_u16(728 + r->coeffs, y1);
  // 736 -> 752
  y0 = vld1q_u16(736 + r->coeffs);
  y1 = vld1q_u16(744 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  y1 = vsubq_u16(y1, y2);
  vst1q_u16(736 + r->coeffs, y0);
  vst1q_u16(744 + r->coeffs, y1);
  // 752 -> 768
  y0 = vld1q_u16(752 + r->coeffs);
  y1 = vld1q_u16(760 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  y1 = vsubq_u16(y1, y2);
  vst1q_u16(752 + r->coeffs, y0);
  vst1q_u16(760 + r->coeffs, y1);
  // 768 -> 784
  y0 = vld1q_u16(768 + r->coeffs);
  y1 = vld1q_u16(776 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  y1 = vsubq_u16(y1, y2);
  vst1q_u16(768 + r->coeffs, y0);
  vst1q_u16(776 + r->coeffs, y1);
  // 784 -> 800
  y0 = vld1q_u16(784 + r->coeffs);
  y1 = vld1q_u16(792 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  y1 = vsubq_u16(y1, y2);
  vst1q_u16(784 + r->coeffs, y0);
  vst1q_u16(792 + r->coeffs, y1);
  // 800 -> 816
  y0 = vld1q_u16(800 + r->coeffs);
  y1 = vld1q_u16(808 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  y1 = vsubq_u16(y1, y2);
  vst1q_u16(800 + r->coeffs, y0);
  vst1q_u16(808 + r->coeffs, y1);
  // 816 -> 832
  y0 = vld1q_u16(816 + r->coeffs);
  y0 = vsubq_u16(y0, y2);
  vst1q_u16(816 + r->coeffs, y0);
  vst1q_u16(824 + r->coeffs, y3);
  r->coeffs[821] = 0;
  r->coeffs[822] = 0;
  r->coeffs[823] = 0;
}
