...
void poly_mod_3_Phi_n(poly *r) {
  ...
  int16x8_t y4, y5, y6, y7, y8;
  uint16x8_t y9, y10, y11, y12, y13, y14, y15;
  y8 = vdupq_n_s16(0x3);
  y14 = vdupq_n_u16(0xff);
  y13 = vdupq_n_u16(0xf);
  y11 = vdupq_n_u16(0);
  y15 = vld1q_u16(816 + r->coeffs);
  y15 = vdupq_laneq_u16(y15, 5);
  y15 = vshlq_n_u16(y15, 1);
  // 0 -> 16
  ...
  y3 = vaddq_u16(y1, y3);
  y0 = vshrq_n_u16(y2, 2);
  y2 = vandq_u16(y2, (uint16x8_t)y8);
  y2 = vaddq_u16(y0, y2);
  y1 = vshrq_n_u16(y3, 2);
  y3 = vandq_u16(y3, (uint16x8_t)y8);
  y3 = vaddq_u16(y1, y3);
  y0 = vshrq_n_u16(y2, 2);
  y2 = vandq_u16(y2, (uint16x8_t)y8);
  y2 = vaddq_u16(y0, y2);
  ...
  y3 = vandq_u16(y3, (uint16x8_t)y8);
  y3 = vaddq_u16(y1, y3);
  y4 = vsubq_s16((int16x8_t)y2, y8);
  y5 = vsubq_s16((int16x8_t)y3, y8);
  y6 = vshrq_n_s16(y4, 15);
  y7 = vshrq_n_s16(y5, 15);
  y0 = vandq_u16((uint16x8_t)y6, y2);
  y6 = vmvnq_s16(y6);
  y4 = vandq_s16(y6, y4);
  y2 = veorq_u16(y0, (uint16x8_t)y4);
  y1 = vandq_u16((uint16x8_t)y7, y3);
  y7 = vmvnq_s16(y7);
  y5 = vandq_s16(y7, y5);
  y3 = veorq_u16(y1, (uint16x8_t)y5);
  // DONE MOD3
