...
void poly_Rq_to_S3(poly *r, const poly *a){
 ...
 y8 = vdupq_n_u16(0x3) ;
 y16 = vdupq_n_s16(0x3) ;
 y10 = vdupq_n_u16(0xfff) ;
 y13 = vdupq_n_u16(0xff) ;
 y14 = vdupq_n_u16(0xf) ;
// Find Last
 y9 = vld1q_u16 (816 + a->coeffs) ;
 y9 = vandq_u16 (y10, y9) ;
 y0 = vshrq_n_u16 (y9, 11) ;
 y0 = veorq_u16 (y8, y0) ;
 y0 = vshlq_n_u16 (y0, 12) ;
 y0 = vaddq_u16 (y0, y9) ;
...
// 0 -> 16
 ...
 y2 = vandq_u16 (y10, y2) ;
 y3 = vandq_u16 (y10, y3) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y1 = vshrq_n_u16 (y3, 11) ;
 y0 = veorq_u16 (y8, y0) ;
 y1 = veorq_u16 (y8, y1) ;
 y0 = vshlq_n_u16 (y0, 12) ;
 y1 = vshlq_n_u16 (y1, 12) ;
 y0 = vaddq_u16 (y0, y2) ;
 y1 = vaddq_u16 (y1, y3) ;
 y0 = vaddq_u16 (y0, y9) ;
 y1 = vaddq_u16 (y1, y9) ;
// MOD3 
 ...
 y11 = vandq_u16 (y11, (uint16x8_t) y16) ;
 y11 = vaddq_u16 (y0, y11) ;
 y1 = vshrq_n_u16 (y12, 2) ;
 y12 = vandq_u16 (y12, (uint16x8_t) y16) ;
 y12 = vaddq_u16 (y1, y12) ;
 y0 = vshrq_n_u16 (y11, 2) ;
 y11 = vandq_u16 (y11, (uint16x8_t) y16) ;
 y11 = vaddq_u16 (y0, y11) ;
 ...
 y12 = vandq_u16 (y12, (uint16x8_t) y16) ;
 y12 = vaddq_u16 (y1, y12) ;
 y4 = vsubq_s16 ( (int16x8_t) y11, y16) ;
 y5 = vsubq_s16 ( (int16x8_t) y12, y16) ;
 y6 = vshrq_n_s16 (y4, 15) ;
 y7 = vshrq_n_s16 (y5, 15) ;
 y0 = vandq_u16 ( (uint16x8_t) y6, y11) ;
 y6 = vmvnq_s16 (y6) ;
 y4 = vandq_s16 (y6, y4) ;
 y11 = veorq_u16 (y0, (uint16x8_t) y4) ;
 y1 = vandq_u16 ( (uint16x8_t) y7, y12) ;
 y7 = vmvnq_s16 (y7) ;
 y5 = vandq_s16 (y7, y5) ;
 y12 = veorq_u16 (y1, (uint16x8_t) y5) ;
// DONE MOD3 
...
// 704 -> 720
 y2 = vld1q_u16 (704 + a->coeffs) ;
 y3 = vld1q_u16 (712 + a->coeffs) ;
 y2 = vandq_u16 (y10, y2) ;
 y3 = vandq_u16 (y10, y3) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y1 = vshrq_n_u16 (y3, 11) ;
...
// MOD3 
 ...
 y12 = veorq_u16 (y1, (uint16x8_t) y5) ;
// DONE MOD3 
vst1q_u16 (704 + r->coeffs, y11);
vst1q_u16 (712 + r->coeffs, y12);
// 720 -> 736
 y2 = vld1q_u16 (720 + a->coeffs) ;
 y3 = vld1q_u16 (728 + a->coeffs) ;
 y2 = vandq_u16 (y10, y2) ;
 y3 = vandq_u16 (y10, y3) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y1 = vshrq_n_u16 (y3, 11) ;
...
// MOD3 
 ...
 y12 = veorq_u16 (y1, (uint16x8_t) y5) ;
// DONE MOD3 
vst1q_u16 (720 + r->coeffs, y11);
vst1q_u16 (728 + r->coeffs, y12);
// 736 -> 752
 y2 = vld1q_u16 (736 + a->coeffs) ;
 y3 = vld1q_u16 (744 + a->coeffs) ;
 y2 = vandq_u16 (y10, y2) ;
 y3 = vandq_u16 (y10, y3) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y1 = vshrq_n_u16 (y3, 11) ;
...
// MOD3 
 ...
 y12 = veorq_u16 (y1, (uint16x8_t) y5) ;
// DONE MOD3 
vst1q_u16 (736 + r->coeffs, y11);
vst1q_u16 (744 + r->coeffs, y12);
// 752 -> 768
 y2 = vld1q_u16 (752 + a->coeffs) ;
 y3 = vld1q_u16 (760 + a->coeffs) ;
 y2 = vandq_u16 (y10, y2) ;
 y3 = vandq_u16 (y10, y3) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y1 = vshrq_n_u16 (y3, 11) ;
...
// MOD3 
 ...
 y12 = veorq_u16 (y1, (uint16x8_t) y5) ;
// DONE MOD3 
vst1q_u16 (752 + r->coeffs, y11);
vst1q_u16 (760 + r->coeffs, y12);
// 768 -> 784
 y2 = vld1q_u16 (768 + a->coeffs) ;
 y3 = vld1q_u16 (776 + a->coeffs) ;
 y2 = vandq_u16 (y10, y2) ;
 y3 = vandq_u16 (y10, y3) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y1 = vshrq_n_u16 (y3, 11) ;
...
// MOD3 
 ...
 y12 = veorq_u16 (y1, (uint16x8_t) y5) ;
// DONE MOD3 
vst1q_u16 (768 + r->coeffs, y11);
vst1q_u16 (776 + r->coeffs, y12);
// 784 -> 800
 y2 = vld1q_u16 (784 + a->coeffs) ;
 y3 = vld1q_u16 (792 + a->coeffs) ;
 y2 = vandq_u16 (y10, y2) ;
 y3 = vandq_u16 (y10, y3) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y1 = vshrq_n_u16 (y3, 11) ;
...
// MOD3 
 ...
 y12 = veorq_u16 (y1, (uint16x8_t) y5) ;
// DONE MOD3 
vst1q_u16 (784 + r->coeffs, y11);
vst1q_u16 (792 + r->coeffs, y12);
// 800 -> 816
 y2 = vld1q_u16 (800 + a->coeffs) ;
 y3 = vld1q_u16 (808 + a->coeffs) ;
 y2 = vandq_u16 (y10, y2) ;
 y3 = vandq_u16 (y10, y3) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y1 = vshrq_n_u16 (y3, 11) ;
...
// MOD3 
 ...
 y12 = veorq_u16 (y1, (uint16x8_t) y5) ;
// DONE MOD3 
vst1q_u16 (800 + r->coeffs, y11);
vst1q_u16 (808 + r->coeffs, y12);
// 816 -> 832
 y2 = vld1q_u16 (816 + a->coeffs) ;
 y2 = vandq_u16 (y10, y2) ;
 y0 = vshrq_n_u16 (y2, 11) ;
 y0 = veorq_u16 (y8, y0) ;
 y0 = vshlq_n_u16 (y0, 12) ;
...
// MOD3 
 ...
 y11 = veorq_u16 (y0, (uint16x8_t) y4) ;
// DONE MOD3 
vst1q_u16 (816 + r->coeffs, y11);
vst1q_u16 (824 + r->coeffs, y15);
 r->coeffs[821] = 0 ;
 r->coeffs[822] = 0 ;
 r->coeffs[823] = 0 ;
}
